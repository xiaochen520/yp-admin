<template>
    <div class="order">
        <div class="filter">
            ...
            <el-input type="text" style="width: 200px" v-model="nickname"></el-input>
        ...
        <el-table :loading="isLoad" :data="tbArr" border style="width: 100%">
            ...
            <el-table-column align="center" prop="userInfo.nickname" label="支付用户">
            </el-table-column>
...
<script>
    import { user, removeOrder } from '@/api'
